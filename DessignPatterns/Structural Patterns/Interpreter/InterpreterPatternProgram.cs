...
using System.Linq;
using System.Text;
using Exercise = DessignPatterns.Structural_Patterns.Interpreter.Exercise;

namespace DessignPatterns.Structural_Patterns.Interpreter
{
    ...
    public class InterpreterPatternProgram
    {
        ...
        {
            string input = "13+4-x";
            var ep = new Exercise.ExpressionProcessor();
            ep.Calculate(input);
        }
    }
}
